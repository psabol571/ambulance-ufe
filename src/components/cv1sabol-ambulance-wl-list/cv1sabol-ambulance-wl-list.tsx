...
import { AmbulanceWaitingListApi, WaitingListEntry, Configuration } from '../../api/ambulance-wl';// import '@material/web/list/list-item'

@Component({
  tag: 'cv1sabol-ambulance-wl-list',
  styleUrl: 'cv1sabol-ambulance-wl-list.css',
  shadow: true,
})
